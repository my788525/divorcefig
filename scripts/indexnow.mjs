// IndexNow submission for divorcefig.com.
// Reads the built sitemap and submits all URLs to IndexNow (Bing/Naver/Yandex).
// Key file (ownership verification): public/<KEY>.txt -> https://divorcefig.com/<KEY>.txt
//
// Usage:
...
const HOST = 'divorcefig.com';
const KEY_FILE = '9ec7a9f329b8b432b1238b10a3f1a0e6.txt';
